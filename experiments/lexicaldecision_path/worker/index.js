...
const options = {
	...
	readQueue: 'lexicaldecision_path_quiz_dbread',
	writeQueue: 'lexicaldecision_path_quiz_dbwrite',
	taskQueue: 'lexicaldecision_path_quiz_taskworker',
};
...
worker.init()
	.then(() => {
		...
		worker.useHandler(defaultHandler, connection, 'lexicaldecision_path', transactionOps);
		worker.start();
	})
	.catch(err => {
