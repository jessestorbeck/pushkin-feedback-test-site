...
const options = {
	...
	readQueue: 'grammaticalityjudgment_path_quiz_dbread',
	writeQueue: 'grammaticalityjudgment_path_quiz_dbwrite',
	taskQueue: 'grammaticalityjudgment_path_quiz_taskworker',
};
...
worker.init()
	.then(() => {
		...
		worker.useHandler(defaultHandler, connection, 'grammaticalityjudgment_path', transactionOps);
		worker.start();
	})
	.catch(err => {
